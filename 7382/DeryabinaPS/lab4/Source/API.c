...
int are_similar(BinTree *bt1, BinTree *bt2, int level, int *is_equal){
	...
	Space(level);
	printf("Comparing:  [%d]<-[%c]->[%d]  [%d]<-[%c]->[%d]\n", bt1[0].left, bt1[0].data, bt1[0].right, bt2[0].left, bt2[0].data, bt2[0].right);
	if (bt1[0].data != bt2[0].data)
                        *is_equal = 0;
	if (bt1[0].left == bt2[0].left && bt1[0].left != -1){
		if (are_similar(bt1+bt1[0].left-bt1[0].size, bt2+bt2[0].left-bt2[0].size, level+1, is_equal) == 0)
			return 0;
	}
	...
	if (bt1[0].right == bt2[0].right && bt1[0].right != -1){
		if (are_similar(bt1+bt1[0].right-bt1[0].size, bt2+bt2[0].right-bt1[0].size, level+1, is_equal) == 0)
			return 0;
	}
...
int are_mirrored(BinTree *bt1, BinTree *bt2, int level, int *is_symm){
	...
	if (bt1[0].left != -1 && bt2[0].right != -1 && bt1[0].right == -1 && bt2[0].left == -1){
		are_mir = 1;
		if (are_mirrored(bt1+bt1[0].left-bt1[0].size, bt2+bt2[0].right-bt2[0].size, level+1, is_symm) == 0)
			return 0;
	}
	if (bt1[0].left == -1 && bt2[0].right == -1 && bt1[0].right != -1 && bt2[0].left != -1){
		are_mir = 1;
		if (are_mirrored(bt1+bt1[0].right-bt1[0].size, bt2+bt2[0].left-bt2[0].size, level+1, is_symm) == 0)
                        return 0;
	}
	if (bt1[0].left != -1 && bt2[0].right != -1 && bt1[0].right != -1 && bt2[0].left != -1){
		are_mir = 1;
